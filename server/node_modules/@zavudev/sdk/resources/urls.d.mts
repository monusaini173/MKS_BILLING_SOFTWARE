...
export declare class URLs extends APIResource {
     ...
     * ```
     */
    escalate(urlID: string, body: URLEscalateParams, options?: RequestOptions): APIPromise<URLEscalateResponse>;
    /**
