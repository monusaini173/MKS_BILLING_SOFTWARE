...
export declare class RegulatoryDocuments extends APIResource {
    /**
     ...
     * ```
     */
    create(body: RegulatoryDocumentCreateParams, options?: RequestOptions): APIPromise<RegulatoryDocumentCreateResponse>;
    /**
     ...
     * ```
     */
    list(query?: RegulatoryDocumentListParams | null | undefined, options?: RequestOptions): PagePromise<RegulatoryDocumentsCursor, RegulatoryDocument>;
    /**
...
export interface RegulatoryDocument {
    id: string;
    createdAt: string;
    documentType: 'passport' | 'national_id' | 'drivers_license' | 'utility_bill' | 'tax_id' | 'business_registration' | 'proof_of_address' | 'other';
    name: string;
...
//# sourceMappingURL=regulatory-documents.d.mts.map