...
export declare class AgentTemplates extends APIResource {
    /**
...
export declare namespace AgentTemplateRetrieveResponse {
    /**
     * A fully rendered factory agent: the function files to scaffold plus the secrets
     * it needs. Returned by GET /v1/agent-templates/{templateId} and consumed by
     * `npx zavudev agents pull`.
...
export declare namespace AgentTemplateListResponse {
    /**
...
export declare namespace AgentTemplates {
    export { type AgentTemplateRetrieveResponse as AgentTemplateRetrieveResponse, type AgentTemplateListResponse as AgentTemplateListResponse, };
}
//# sourceMappingURL=agent-templates.d.mts.map