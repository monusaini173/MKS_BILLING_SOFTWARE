...
export declare class Messages extends APIResource {
     ...
     * ```
     */
    react(messageID: string, params: MessageReactParams, options?: RequestOptions): APIPromise<MessageResponse>;
    /**
 ...
 */
export type Channel = 'auto' | 'sms' | 'sms_oneway' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice';
 ...
 * automatically links the phone number to that contact.
 */
export type MessageType = 'text' | 'image' | 'video' | 'audio' | 'document' | 'sticker' | 'location' | 'contact' | 'buttons' | 'list' | 'cta_url' | 'request_contact_info' | 'location_request' | 'reaction' | 'template';
export interface MessageListAttachmentsResponse {
    items: Array<MessageListAttachmentsResponse.Item>;
}
export declare namespace MessageListAttachmentsResponse {
    /**
