...
import { PhoneNumberAssignParams, PhoneNumberAssignResponse, PhoneNumberListResponse, PhoneNumberUnassignParams, PhoneNumbers, TenDlcPhoneNumberAssignment } from "./phone-numbers.mjs";
...
export declare class Campaigns extends APIResource {
     ...
     * ```
     */
    update(campaignID: string, body: CampaignUpdateParams, options?: RequestOptions): APIPromise<CampaignUpdateResponse>;
    /**
     ...
     * ```
     */
    list(query?: CampaignListParams | null | undefined, options?: RequestOptions): PagePromise<TenDlcCampaignsCursor, TenDlcCampaign>;
    /**
...
export declare namespace Campaigns {
    export { type TenDlcCampaign as TenDlcCampaign, type CampaignCreateResponse as CampaignCreateResponse, type CampaignRetrieveResponse as CampaignRetrieveResponse, type CampaignUpdateResponse as CampaignUpdateResponse, type CampaignSubmitResponse as CampaignSubmitResponse, type CampaignSyncStatusResponse as CampaignSyncStatusResponse, type TenDlcCampaignsCursor as TenDlcCampaignsCursor, type CampaignCreateParams as CampaignCreateParams, type CampaignUpdateParams as CampaignUpdateParams, type CampaignListParams as CampaignListParams, };
    export { PhoneNumbers as PhoneNumbers, type TenDlcPhoneNumberAssignment as TenDlcPhoneNumberAssignment, type PhoneNumberListResponse as PhoneNumberListResponse, type PhoneNumberAssignResponse as PhoneNumberAssignResponse, type PhoneNumberAssignParams as PhoneNumberAssignParams, type PhoneNumberUnassignParams as PhoneNumberUnassignParams, };
}
