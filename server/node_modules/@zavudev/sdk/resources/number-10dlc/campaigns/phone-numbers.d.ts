...
export declare class PhoneNumbers extends APIResource {
     ...
     * ```
     */
    assign(campaignID: string, body: PhoneNumberAssignParams, options?: RequestOptions): APIPromise<PhoneNumberAssignResponse>;
    /**
     ...
     * ```
     */
    unassign(assignmentID: string, params: PhoneNumberUnassignParams, options?: RequestOptions): APIPromise<void>;
}
