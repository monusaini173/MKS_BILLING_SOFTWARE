...
import { ExecutionListParams, ExecutionRetrieveParams, ExecutionRetrieveResponse, Executions } from "./executions.mjs";
import * as FlowsAPI from "./flows.mjs";
import { AgentFlow, AgentFlowsCursor, FlowCreateParams, FlowCreateResponse, FlowDeleteParams, FlowDuplicateParams, FlowDuplicateResponse, FlowListParams, FlowRetrieveParams, FlowRetrieveResponse, FlowStep, FlowTrigger, FlowUpdateParams, FlowUpdateResponse, Flows } from "./flows.mjs";
...
import { AgentTool, AgentToolsCursor, ToolCreateParams, ToolCreateResponse, ToolDeleteParams, ToolListParams, ToolListTestRunsParams, ToolListTestRunsResponse, ToolParameters, ToolRetrieveParams, ToolRetrieveResponse, ToolTestParams, ToolTestResponse, ToolUpdateParams, ToolUpdateResponse, Tools } from "./tools/tools.mjs";
...
export declare namespace AgentResource {
    ...
    export { Executions as Executions, type ExecutionRetrieveResponse as ExecutionRetrieveResponse, type ExecutionRetrieveParams as ExecutionRetrieveParams, type ExecutionListParams as ExecutionListParams, };
    ...
    export { Tools as Tools, type AgentTool as AgentTool, type ToolParameters as ToolParameters, type ToolCreateResponse as ToolCreateResponse, type ToolRetrieveResponse as ToolRetrieveResponse, type ToolUpdateResponse as ToolUpdateResponse, type ToolListTestRunsResponse as ToolListTestRunsResponse, type ToolTestResponse as ToolTestResponse, type AgentToolsCursor as AgentToolsCursor, type ToolCreateParams as ToolCreateParams, type ToolRetrieveParams as ToolRetrieveParams, type ToolUpdateParams as ToolUpdateParams, type ToolListParams as ToolListParams, type ToolDeleteParams as ToolDeleteParams, type ToolListTestRunsParams as ToolListTestRunsParams, type ToolTestParams as ToolTestParams, };
