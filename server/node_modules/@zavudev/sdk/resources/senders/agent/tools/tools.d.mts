...
import { Webhook, WebhookRotateSecretParams } from "./webhook.mjs";
...
export declare class Tools extends APIResource {
     ...
     * ```
     */
    listTestRuns(toolID: string, params: ToolListTestRunsParams, options?: RequestOptions): APIPromise<ToolListTestRunsResponse>;
    /**
...
export declare namespace ToolListTestRunsResponse {
    /**
