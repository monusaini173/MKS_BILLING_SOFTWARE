...
export declare class Documents extends APIResource {
     ...
     * ```
     */
    retrieveDocument(docID: string, params: DocumentRetrieveDocumentParams, options?: RequestOptions): APIPromise<DocumentRetrieveDocumentResponse>;
    /**
     ...
     * ```
     */
    updateDocument(docID: string, params: DocumentUpdateDocumentParams, options?: RequestOptions): APIPromise<DocumentUpdateDocumentResponse>;
}
...
export declare namespace Documents {
    export { type DocumentCreateResponse as DocumentCreateResponse, type DocumentRetrieveDocumentResponse as DocumentRetrieveDocumentResponse, type DocumentUpdateDocumentResponse as DocumentUpdateDocumentResponse, type DocumentCreateParams as DocumentCreateParams, type DocumentListParams as DocumentListParams, type DocumentDeleteParams as DocumentDeleteParams, type DocumentRetrieveDocumentParams as DocumentRetrieveDocumentParams, type DocumentUpdateDocumentParams as DocumentUpdateDocumentParams, };
}
