...
export declare class Telegram extends APIResource {
    /**
     ...
     * ```
     */
    connect(senderID: string, body: TelegramConnectParams, options?: RequestOptions): APIPromise<TelegramConnectResponse>;
    /**
...
export declare namespace TelegramConnectResponse {
    interface Telegram {
        connected: boolean;
        botId?: string;
        botUsername?: string;
...
export declare namespace Telegram {
    export { type TelegramConnectResponse as TelegramConnectResponse, type TelegramConnectParams as TelegramConnectParams, };
}
