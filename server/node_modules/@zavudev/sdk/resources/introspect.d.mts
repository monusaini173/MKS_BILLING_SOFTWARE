...
import * as IntrospectAPI from "./introspect.mjs";
...
export declare class Introspect extends APIResource {
     ...
     * ```
     */
    validateEmail(body: IntrospectValidateEmailParams, options?: RequestOptions): APIPromise<IntrospectValidateEmailResponse>;
    /**
...
export declare namespace IntrospectValidateEmailResponse {
    interface Result {
        /**
         ...
         */
        reasons: Array<'invalid_syntax' | 'domain_not_found' | 'domain_no_mx' | 'disposable_domain' | 'role_address' | 'suppressed_hard_bounce' | 'suppressed_soft_bounce' | 'suppressed_complaint' | 'suppressed_manual' | 'suppressed_unsubscribe'>;
        /**
         * Validation verdict.
         *
