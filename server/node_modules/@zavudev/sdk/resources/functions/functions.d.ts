...
import * as GitLinkAPI from "./git-link.js";
import { GitLink, GitLinkDeployNowResponse, GitLinkLinkParams, GitLinkLinkResponse, GitLinkRetrieveResponse, GitLinkUpdateParams, GitLinkUpdateResponse } from "./git-link.js";
import * as SecretsAPI from "./secrets.js";
import { SecretListResponse, SecretSetParams, SecretSetResponse, SecretUnsetParams, Secrets } from "./secrets.js";
import * as TriggersAPI from "./triggers.js";
import { TriggerCreateParams, TriggerCreateResponse, TriggerListResponse, TriggerUpdateParams, TriggerUpdateResponse, Triggers } from "./triggers.js";
...
export declare class Functions extends APIResource {
     ...
     * ```
     */
    listDeployments(functionID: string, query?: FunctionListDeploymentsParams | null | undefined, options?: RequestOptions): APIPromise<FunctionListDeploymentsResponse>;
    /**
     ...
     * ```
     */
    rollbackDeployment(functionID: string, body: FunctionRollbackDeploymentParams, options?: RequestOptions): APIPromise<FunctionRollbackDeploymentResponse>;
    /**
...
export declare namespace FunctionListDeploymentsResponse {
    interface Deployment {
        id?: string;
...
export declare namespace FunctionRollbackDeploymentResponse {
    interface Deployment {
        id: string;
        createdAt: string;
        functionId: string;
...
export declare namespace Functions {
    ...
    export { Triggers as Triggers, type TriggerCreateResponse as TriggerCreateResponse, type TriggerUpdateResponse as TriggerUpdateResponse, type TriggerListResponse as TriggerListResponse, type TriggerCreateParams as TriggerCreateParams, type TriggerUpdateParams as TriggerUpdateParams, };
    export { GitLink as GitLink, type GitLinkRetrieveResponse as GitLinkRetrieveResponse, type GitLinkUpdateResponse as GitLinkUpdateResponse, type GitLinkDeployNowResponse as GitLinkDeployNowResponse, type GitLinkLinkResponse as GitLinkLinkResponse, type GitLinkUpdateParams as GitLinkUpdateParams, type GitLinkLinkParams as GitLinkLinkParams, };
}
