...
export declare class Triggers extends APIResource {
     ...
     * ```
     */
    create(functionID: string, body: TriggerCreateParams, options?: RequestOptions): APIPromise<TriggerCreateResponse>;
    /**
     ...
     * ```
     */
    update(triggerID: string, body: TriggerUpdateParams, options?: RequestOptions): APIPromise<TriggerUpdateResponse>;
    /**
...
export declare namespace TriggerCreateResponse {
    /**
...
export declare namespace Triggers {
    export { type TriggerCreateResponse as TriggerCreateResponse, type TriggerUpdateResponse as TriggerUpdateResponse, type TriggerListResponse as TriggerListResponse, type TriggerCreateParams as TriggerCreateParams, type TriggerUpdateParams as TriggerUpdateParams, };
}
