...
exports.GitLink = void 0;
const resource_1 = require("../../core/resource.js");
const headers_1 = require("../../internal/headers.js");
const path_1 = require("../../internal/utils/path.js");
class GitLink extends resource_1.APIResource {
    /**
    ...
    retrieve(functionID, options) {
        return this._client.get((0, path_1.path) `/v1/functions/${functionID}/git-link`, options);
    }
    /**
    ...
    update(functionID, body, options) {
        return this._client.patch((0, path_1.path) `/v1/functions/${functionID}/git-link`, { body, ...options });
    }
    /**
     ...
     * ```
     */
    deployNow(functionID, options) {
        return this._client.post((0, path_1.path) `/v1/functions/${functionID}/git-link/deploy`, options);
    }
    /**
     ...
     * ```
     */
    link(functionID, body, options) {
        return this._client.post((0, path_1.path) `/v1/functions/${functionID}/git-link`, { body, ...options });
    }
    /**
     ...
     * ```
     */
    unlink(functionID, options) {
        return this._client.delete((0, path_1.path) `/v1/functions/${functionID}/git-link`, {
            ...options,
...
//# sourceMappingURL=git-link.js.map