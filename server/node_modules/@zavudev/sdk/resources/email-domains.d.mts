...
export declare class EmailDomains extends APIResource {
    /**
...
export declare namespace EmailDomainCreateResponse {
    interface Domain {
        id: string;
        dkimStatus: string;
        domain: string;
...
export declare namespace EmailDomainRetrieveResponse {
    interface Domain {
        id: string;
        dkimStatus: string;
        domain: string;
...
export declare namespace EmailDomainListResponse {
    interface Item {
        id: string;
        dkimStatus: string;
        domain: string;
...
export declare namespace EmailDomainVerifyResponse {
    interface Domain {
        id: string;
        dkimStatus: string;
        domain: string;
...
export declare namespace EmailDomains {
    export { type EmailDomainCreateResponse as EmailDomainCreateResponse, type EmailDomainRetrieveResponse as EmailDomainRetrieveResponse, type EmailDomainListResponse as EmailDomainListResponse, type EmailDomainVerifyResponse as EmailDomainVerifyResponse, type EmailDomainCreateParams as EmailDomainCreateParams, };
}
//# sourceMappingURL=email-domains.d.mts.map