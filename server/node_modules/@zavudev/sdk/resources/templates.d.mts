...
export declare class Templates extends APIResource {
     ...
     * ```
     */
    list(query?: TemplateListParams | null | undefined, options?: RequestOptions): PagePromise<TemplatesCursor, Template>;
    /**
     * Delete template
     *
     * @example
     ...
     * ```
     */
    sync(body?: TemplateSyncParams | null | undefined, options?: RequestOptions): APIPromise<TemplateSyncResponse>;
}
