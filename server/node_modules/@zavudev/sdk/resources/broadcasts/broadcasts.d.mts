...
import { ContactAddParams, ContactAddResponse, ContactListParams, ContactRemoveParams, Contacts } from "./contacts.mjs";
...
export declare class Broadcasts extends APIResource {
     ...
     * ```
     */
    reschedule(broadcastID: string, body: BroadcastRescheduleParams, options?: RequestOptions): APIPromise<BroadcastRescheduleResponse>;
    /**
 ...
 * Current status of the broadcast.
 */
export type BroadcastStatus = 'draft' | 'pending_review' | 'approved' | 'rejected' | 'escalated' | 'rejected_final' | 'scheduled' | 'sending' | 'paused' | 'completed' | 'cancelled' | 'failed';
