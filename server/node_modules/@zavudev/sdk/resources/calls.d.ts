...
export declare class Calls extends APIResource {
     ...
     * ```
     */
    list(query?: CallListParams | null | undefined, options?: RequestOptions): PagePromise<CallListResponsesCursor, CallListResponse>;
    /**
...
export declare namespace CallHangupResponse {
    interface Call {
        id: string;
        createdAt: string;
        /**
