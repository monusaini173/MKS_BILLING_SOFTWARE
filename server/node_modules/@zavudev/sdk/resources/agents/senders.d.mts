...
export declare class Senders extends APIResource {
     ...
     * ```
     */
    connect(agentID: string, body: SenderConnectParams, options?: RequestOptions): APIPromise<SenderConnectResponse>;
    /**
...
export declare namespace Senders {
    export { type SenderConnectResponse as SenderConnectResponse, type SenderConnectParams as SenderConnectParams, type SenderDisconnectParams as SenderDisconnectParams, };
}
