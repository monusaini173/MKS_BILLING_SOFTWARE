...
import { SenderConnectParams, SenderConnectResponse, SenderDisconnectParams, Senders } from "./senders.mjs";
import * as AgentAPI from "../senders/agent/agent.mjs";
import { AgentsCursor } from "../senders/agent/agent.mjs";
...
export declare class Agents extends APIResource {
     ...
     * ```
     */
    update(agentID: string, body: AgentUpdateParams, options?: RequestOptions): APIPromise<AgentUpdateResponse>;
    /**
     ...
     * ```
     */
    list(query?: AgentListParams | null | undefined, options?: RequestOptions): PagePromise<AgentsCursor, AgentAPI.Agent>;
    /**
     * Delete an agent
     *
     * @example
     ...
     * ```
     */
    listVoices(query?: AgentListVoicesParams | null | undefined, options?: RequestOptions): APIPromise<AgentListVoicesResponse>;
    /**
...
export declare namespace AgentListVoicesResponse {
    interface Item {
        /**
...
export declare namespace AgentTestResponse {
...
export declare namespace AgentTestParams {
    interface History {
        content: string;
        role: 'user' | 'assistant';
    }
...
export declare namespace Agents {
    export { type AgentCreateResponse as AgentCreateResponse, type AgentRetrieveResponse as AgentRetrieveResponse, type AgentUpdateResponse as AgentUpdateResponse, type AgentListVoicesResponse as AgentListVoicesResponse, type AgentTestResponse as AgentTestResponse, type AgentCreateParams as AgentCreateParams, type AgentUpdateParams as AgentUpdateParams, type AgentListParams as AgentListParams, type AgentListVoicesParams as AgentListVoicesParams, type AgentTestParams as AgentTestParams, };
    export { Senders as Senders, type SenderConnectResponse as SenderConnectResponse, type SenderConnectParams as SenderConnectParams, type SenderDisconnectParams as SenderDisconnectParams, };
}
